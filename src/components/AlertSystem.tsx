...
import { Bell, AlertTriangle, Info, X, Globe, Loader2 } from 'lucide-react';
import translationService, { Language } from '../lib/translationService';
...
export default function AlertSystem() {
  ...
  const getTranslationForText = (text: string, targetLang: Language): string => {
    const exactMatches: { [key: string]: { [lang in Language]: string } } = {
      ...
      'Shelter in place': {
        en: 'Shelter in place',
        es: 'Refugiarse en el lugar',
        fr: 'Se mettre à l\'abri sur place',
        zh: '就地避难',
        ar: 'البقاء في المكان'
      },
      'Medical emergency': {
      ...
      'Seek immediate shelter': {
        en: 'Seek immediate shelter',
        es: 'Busque refugio inmediato',
        fr: 'Cherchez un abri immédiat',
        zh: '立即寻求庇护',
        ar: 'اطلب المأوى الفوري'
      }
    };
